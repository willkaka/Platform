...
public class Menuconfig2 {
	...
	public Menuconfig2(String pearentMenuCode, Connection connection){
		try{
	...
	public static Menuconfig2 getMenuConfig(String menuId, Connection connection){
		Menuconfig2 menu = null;
	...
	public static Vector<Menuconfig2> getMenuConfigs(Connection connection){
		Vector<Menuconfig2> menus = new Vector<Menuconfig2>();
		...
		try{
			...
			while (set.next()) {
				Menuconfig2 menu = new Menuconfig2();
				menu.setMenuid(set.getString("menuid"));
				menu.setMenuCode(set.getString("menuCode"));
				menu.setLevel(set.getInt("level"));
				menu.setPearentMenuCode(set.getString("pearentmenucode"));
	...
	public static Vector<Menuconfig2> getMenuConfigByLevel(String menutype, int level, Connection connection){
		Vector<Menuconfig2> menus = new Vector<Menuconfig2>();
	...
	public static Vector<Menuconfig2> getSubMenuConfig(String pearentMenuCode, Connection connection){
		Vector<Menuconfig2> menus = new Vector<Menuconfig2>();
		...
		try{
			...
			while (set.next()) {
				Menuconfig2 menu = new Menuconfig2(pearentMenuCode, connection);
				menu.setMenuid(set.getString("menuid"));
				menu.setMenuCode(set.getString("menuCode"));
				menu.setLevel(set.getInt("level"));
				menu.setPearentMenuCode(set.getString("pearentMenuCode"));
