...
(2025070100006317, 'EM006317', 17, 'DataDict', 'dictDetailOutPage', 'dictDetailOutArea', 'dictDetailOutArea1', 'div', '', '', ''),
(2025070100006318, 'EM006318', 18, 'DataDict', 'dictDetailOutPage', 'dictDetailOutArea1', 'enumButtonArea', 'div', '', '', ''),
(2025070100006319, 'EM006319', 19, 'DataDict', 'dictDetailOutPage', 'enumButtonArea', 'addNewEnum', 'button', '新增枚举', 'class="inputArea_sub_button"', ''),
(2025070100006320, 'EM006320', 20, 'DataDict', 'dictDetailOutPage', 'dictDetailOutArea1', 'dictDetailDiv', 'div', 'div', 'class="inputArea background_color_1"', ''),
(2025070100006321, 'EM006321', 21, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'dictDetailDivTitle', 'divTitle', '字典详情', 'class="content_title"', ''),
(2025070100006322, 'EM006322', 22, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'ld_dictCode', 'input', '字典码', '', '{"dataField":"dictCode"}'),
(2025070100006323, 'EM006323', 23, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'ld_dictDesc', 'input', '字典描述', '', '{"dataField":"description"}'),
(2025070100006324, 'EM006324', 24, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'dictEnumPDiv', 'div', '字典枚举div', '', ''),
(2025070100006325, 'EM006325', 25, 'DataDict', 'dictEnumPage', 'dictEnumPDiv', 'dictEnumDiv', 'div', 'div', '', ''),
(2025070100006326, 'EM006326', 26, 'DataDict', 'dictEnumPage', 'dictEnumDiv', 'dictEnumDivTitle', 'divTitle', '字典枚举定义', 'class="content_title"', ''),
(2025070100006327, 'EM006327', 27, 'DataDict', 'dictEnumPage', 'dictEnumDiv', 'dictEnumTable', 'table', '字典枚举定义表', 'class="output_table"', '{"hideFields":["sysDictId"]}'),
(2025070100006328, 'EM006328', 28, 'DataDict', 'dictEnumPage', 'dictEnumTable', 'edt_enum_button', 'table_record_button', '编辑', 'class="label_button"', NULL),
(2025070100006329, 'EM006329', 29, 'DataDict', 'dictEnumPage', 'dictEnumTable', 'del_enum_button', 'table_record_button', '删除', 'class="label_button"', NULL),
(2025070100006330, 'EM006330', 30, 'DataDict', 'add_dict_sbw', 'body', 'add_dict_sub_window', 'subWindow', '新增字典定义', '', NULL),
(2025070100006331, 'EM006331', 31, 'DataDict', 'add_dict_sbw', 'add_dict_sub_window_swBody', 'add_dict_sbw_div', 'div', '', 'class="showWithRowDivGrid"', NULL),
(2025070100006332, 'EM006332', 32, 'DataDict', 'add_dict_sbw', 'add_dict_sbw_div', 'dictCode', 'input', '字典码', 'out="Y"', NULL),
(2025070100006333, 'EM006333', 33, 'DataDict', 'add_dict_sbw', 'add_dict_sbw_div', 'description', 'input', '字典描述', 'out="Y"', NULL),
(2025070100006334, 'EM006334', 34, 'DataDict', 'add_dict_sbw', 'add_dict_sub_window_swFooter', 'addDictButton', 'button', '提交', 'class="inputArea_sub_button"', ''),
(2025070100006335, 'EM006335', 35, 'DataDict', 'edt_dict_sbw', 'body', 'edt_dict_sub_window', 'subWindow', '编辑字典定义', '', NULL),
(2025070100006336, 'EM006336', 36, 'DataDict', 'edt_dict_sbw', 'edt_dict_sub_window_swBody', 'edt_dict_sbw_div', 'div', '', 'class="showWithRowDivGrid"', NULL),
(2025070100006337, 'EM006337', 37, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_div', 'sys_dict_id', 'input', 'id', 'out="Y"', '{"hide":true}'),
(2025070100006338, 'EM006338', 38, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_div', 'dictCode', 'input', '字典码', 'out="Y"', NULL),
(2025070100006339, 'EM006339', 39, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_div', 'description', 'input', '字典描述', 'out="Y"', NULL),
(2025070100006340, 'EM006340', 40, 'DataDict', 'edt_dict_sbw', 'edt_dict_sub_window_swFooter', 'edtDictButton', 'button', '提交', 'class="inputArea_sub_button"', NULL),
(2025070100006341, 'EM006341', 41, 'DataDict', 'add_enum_sbw', 'body', 'add_enum_sub_window', 'subWindow', '新增枚举', '', NULL),
(2025070100006342, 'EM006342', 42, 'DataDict', 'add_enum_sbw', 'add_enum_sub_window_swBody', 'add_enum_sbw_div', 'div', '', 'class="showWithRowDivGrid"', ''),
(2025070100006343, 'EM006343', 43, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'dictCode', 'input', '字典码', 'out="Y"', '{"valueFrmWeb":"ld_dictCode","hide":true}'),
(2025070100006344, 'EM006344', 44, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'enumCode', 'input', '枚举码', 'out="Y"', NULL),
(2025070100006345, 'EM006345', 45, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'enumValue', 'input', '枚举值', 'out="Y"', NULL),
(2025070100006346, 'EM006346', 46, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'description', 'input', '描述', 'out="Y"', NULL),
(2025070100006347, 'EM006347', 47, 'DataDict', 'add_enum_sbw', 'add_enum_sub_window_swFooter', 'addEnumButton', 'button', '提交', 'class="inputArea_sub_button"', NULL),
(2025070100006348, 'EM006348', 48, 'DataDict', 'edt_enum_sbw', 'body', 'edt_enum_sub_window', 'subWindow', '编辑字典定义', '', NULL),
(2025070100006349, 'EM006349', 49, 'DataDict', 'edt_enum_sbw', 'edt_enum_sub_window_swBody', 'edt_enum_sbw_div', 'div', '', 'class="showWithRowDivGrid"', NULL),
(2025070100006350, 'EM006350', 50, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'sysDictId', 'input', '字典记录id', 'out="Y"', '{"hide":true}'),
(2025070100006351, 'EM006351', 51, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'enumCode', 'input', '枚举码', 'out="Y"', NULL),
(2025070100006352, 'EM006352', 52, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'enumValue', 'input', '枚举值', 'out="Y"', NULL),
(2025070100006353, 'EM006353', 53, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'description', 'input', '描述', 'out="Y"', NULL),
(2025070100006354, 'EM006354', 54, 'DataDict', 'edt_enum_sbw', 'edt_enum_sub_window_swFooter', 'edtEnumButton', 'button', '提交', 'class="inputArea_sub_button"', NULL);
...
(2025070100006305, 'DataDict', 'out_page', 'dsp_enum_button', 'click', 'buttonReq', 'getDictDef', 'DataDict#dictDetailOutPage#dictDetailOutArea1', '{"host":"lcs"}'),
(2025070100006306, 'DataDict', 'out_page', 'edt_dict_button', 'click', 'swDataReq', 'DataDict', 'edt_dict_sbw', '{"valueFromSelectedRecord":true}'),
(2025070100006307, 'DataDict', 'edt_dict_sbw', 'edtDictButton', 'click', 'buttonReq', 'updDictDef', NULL, '{"host":"lcs"}'),
(2025070100006308, 'DataDict', 'out_page', 'del_dict_button', 'click', 'buttonReq', 'delDictDef', NULL, '{"showConfirmSW":true,"confirmCnt":"是否确认删除？","host":"lcs"}'),
(2025070100006309, 'DataDict', 'dictDetailOutPage', 'addNewEnum', 'click', 'swDataReq', 'DataDict', 'add_enum_sbw', ''),
(2025070100006310, 'DataDict', 'add_enum_sbw', 'addEnumButton', 'click', 'buttonReq', 'addDictEnum', NULL, '{"host":"lcs"}'),
(2025070100006311, 'DataDict', 'dictEnumPage', 'edt_enum_button', 'click', 'swDataReq', 'DataDict', 'edt_enum_sbw', '{"valueFromSelectedRecord":true}'),
(2025070100006312, 'DataDict', 'edt_enum_sbw', 'edtEnumButton', 'click', 'buttonReq', 'updDictEnum', NULL, '{"host":"lcs"}'),
(2025070100006313, 'DataDict', 'dictEnumPage', 'del_enum_button', 'click', 'buttonReq', 'delDictEnum', NULL, '{"showConfirmSW":true,"confirmCnt":"是否确认删除？","host":"lcs"}');
...
('pageDictEnum', 'req', 1, 'dictCode', 'req.webValueDto.webInputValueMap.ld_dictCode.value', 'String', '字典码值'),
