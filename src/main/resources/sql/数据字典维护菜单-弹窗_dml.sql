...
(2025070100006301, 'EM006301', 01, 'DataDict', 'start_page', 'contentArea', 'inputArea', 'div', '', '', ''),
...
(2025070100006304, 'EM006304', 04, 'DataDict', 'start_page', 'inputArea', 'queryArea', 'div', '', 'class="area_div"', ''),
...
(2025070100006308, 'EM006308', 08, 'DataDict', 'start_page', 'inputArea', 'outArea', 'div', '', '', ''),
...
(2025070100006311, 'EM006311', 11, 'DataDict', 'out_page', 'outAreaDiv1', 'outAreaDiv2', 'div', '', '', ''),
(2025070100006312, 'EM006312', 12, 'DataDict', 'out_page', 'outAreaDiv2', 'outAreaDiv3', 'div', '', 'class="area_div"', ''),
(2025070100006313, 'EM006313', 13, 'DataDict', 'out_page', 'outAreaDiv3', 'outAreaDivTitle', 'divTitle', '查询结果', 'class="content_title"', ''),
(2025070100006314, 'EM006314', 14, 'DataDict', 'out_page', 'outAreaDiv3', 'dictTable', 'table', '字典定义表', 'class="output_table"', '{"hideFields":["sysDictId"]}'),
(2025070100006315, 'EM006315', 15, 'DataDict', 'out_page', 'dictTable', 'dsp_enum_button', 'table_record_button', '枚举详情', 'class="label_button"', NULL),
(2025070100006316, 'EM006316', 16, 'DataDict', 'out_page', 'dictTable', 'edt_dict_button', 'table_record_button', '编辑', 'class="label_button"', NULL),
(2025070100006317, 'EM006317', 17, 'DataDict', 'out_page', 'dictTable', 'del_dict_button', 'table_record_button', '删除', 'class="label_button"', NULL),
(2025070100006318, 'EM006318', 18, 'DataDict', 'out_page', 'outAreaDiv2', 'dictDetailOutArea', 'div', '', '', ''),
(2025070100006319, 'EM006319', 19, 'DataDict', 'dictDetailOutPage', 'body', 'dict_detail_sub_window', 'subWindow', '字典明细', '', NULL),
(2025070100006320, 'EM006320', 20, 'DataDict', 'dictDetailOutPage', 'dict_detail_sub_window', 'dictDetailOutArea1', 'div', '', '', ''),
(2025070100006321, 'EM006321', 21, 'DataDict', 'dictDetailOutPage', 'dictDetailOutArea1', 'dictDetailOutArea2', 'div', '', '', ''),
(2025070100006322, 'EM006322', 22, 'DataDict', 'dictDetailOutPage', 'dictDetailOutArea2', 'enumButtonArea', 'div', '', '', ''),
(2025070100006323, 'EM006323', 23, 'DataDict', 'dictDetailOutPage', 'enumButtonArea', 'addNewEnum', 'button', '新增枚举', 'class="inputArea_sub_button"', ''),
(2025070100006324, 'EM006324', 24, 'DataDict', 'dictDetailOutPage', 'dictDetailOutArea2', 'dictDetailDiv', 'div', 'div', 'class="inputArea background_color_1"', ''),
(2025070100006325, 'EM006325', 25, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'dictDetailDivTitle', 'divTitle', '字典详情', 'class="content_title"', ''),
(2025070100006326, 'EM006326', 26, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'ld_dictCode', 'input', '字典码', '', '{"dataField":"dictCode"}'),
(2025070100006327, 'EM006327', 27, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'ld_dictDesc', 'input', '字典描述', '', '{"dataField":"description"}'),
(2025070100006328, 'EM006328', 28, 'DataDict', 'dictDetailOutPage', 'dictDetailDiv', 'dictEnumPDiv', 'div', '字典枚举div', '', ''),
(2025070100006329, 'EM006329', 29, 'DataDict', 'dictEnumPage', 'dictEnumPDiv', 'dictEnumDiv', 'div', 'div', '', ''),
(2025070100006330, 'EM006330', 30, 'DataDict', 'dictEnumPage', 'dictEnumDiv', 'dictEnumDivTitle', 'divTitle', '字典枚举定义', 'class="content_title"', ''),
(2025070100006331, 'EM006331', 31, 'DataDict', 'dictEnumPage', 'dictEnumDiv', 'dictEnumTable', 'table', '字典枚举定义表', 'class="output_table"', '{"hideFields":["sysDictId"]}'),
(2025070100006332, 'EM006332', 32, 'DataDict', 'dictEnumPage', 'dictEnumTable', 'edt_enum_button', 'table_record_button', '编辑', 'class="label_button"', NULL),
(2025070100006333, 'EM006333', 33, 'DataDict', 'dictEnumPage', 'dictEnumTable', 'del_enum_button', 'table_record_button', '删除', 'class="label_button"', NULL),
(2025070100006334, 'EM006334', 34, 'DataDict', 'add_dict_sbw', 'body', 'add_dict_sub_window', 'subWindow', '新增字典定义', '', NULL),
(2025070100006335, 'EM006335', 35, 'DataDict', 'add_dict_sbw', 'add_dict_sub_window', 'add_dict_sbw_div', 'div', '', 'class="showWithRowDivGrid"', NULL),
(2025070100006336, 'EM006336', 36, 'DataDict', 'add_dict_sbw', 'add_dict_sbw_div', 'dictCode', 'input', '字典码', 'out="Y"', NULL),
(2025070100006337, 'EM006337', 37, 'DataDict', 'add_dict_sbw', 'add_dict_sbw_div', 'description', 'input', '字典描述', 'out="Y"', NULL),
(2025070100006338, 'EM006338', 38, 'DataDict', 'add_dict_sbw', 'add_dict_sub_window', 'add_dict_sbw_footer_div', 'div', '', 'class="subWidowFooter"', NULL),
(2025070100006339, 'EM006339', 39, 'DataDict', 'add_dict_sbw', 'add_dict_sbw_footer_div', 'addDictButton', 'button', '提交', 'class="inputArea_sub_button"', ''),
(2025070100006340, 'EM006340', 40, 'DataDict', 'edt_dict_sbw', 'body', 'edt_dict_sub_window', 'subWindow', '编辑字典定义', '', NULL),
(2025070100006341, 'EM006341', 41, 'DataDict', 'edt_dict_sbw', 'edt_dict_sub_window', 'edt_dict_sbw_div', 'div', '', 'class="showWithRowDivGrid"', NULL),
(2025070100006342, 'EM006342', 42, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_div', 'sys_dict_id', 'input', 'id', 'out="Y"', '{"hide":true}'),
(2025070100006343, 'EM006343', 43, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_div', 'dictCode', 'input', '字典码', 'out="Y"', NULL),
(2025070100006344, 'EM006344', 44, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_div', 'description', 'input', '字典描述', 'out="Y"', NULL),
(2025070100006345, 'EM006345', 45, 'DataDict', 'edt_dict_sbw', 'edt_dict_sub_window', 'edt_dict_sbw_footer_div', 'div', '', 'class="subWidowFooter"', NULL),
(2025070100006346, 'EM006346', 46, 'DataDict', 'edt_dict_sbw', 'edt_dict_sbw_footer_div', 'edtDictButton', 'button', '提交', 'class="inputArea_sub_button"', NULL),
(2025070100006347, 'EM006347', 47, 'DataDict', 'add_enum_sbw', 'body', 'add_enum_sub_window', 'subWindow', '新增枚举', '', NULL),
(2025070100006348, 'EM006348', 48, 'DataDict', 'add_enum_sbw', 'add_enum_sub_window', 'add_enum_sbw_div', 'div', '', 'class="showWithRowDivGrid"', ''),
(2025070100006349, 'EM006349', 49, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'dictCode', 'input', '字典码', 'out="Y"', '{"valueFrmWeb":"ld_dictCode","hide":true}'),
(2025070100006350, 'EM006350', 50, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'enumCode', 'input', '枚举码', 'out="Y"', NULL),
(2025070100006351, 'EM006351', 51, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'enumValue', 'input', '枚举值', 'out="Y"', NULL),
(2025070100006352, 'EM006352', 52, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_div', 'description', 'input', '描述', 'out="Y"', NULL),
(2025070100006353, 'EM006353', 53, 'DataDict', 'add_enum_sbw', 'add_enum_sub_window', 'add_enum_sbw_footer_div', 'div', '', 'class="subWidowFooter"', NULL),
(2025070100006354, 'EM006354', 54, 'DataDict', 'add_enum_sbw', 'add_enum_sbw_footer_div', 'addEnumButton', 'button', '提交', 'class="inputArea_sub_button"', NULL),
(2025070100006355, 'EM006355', 55, 'DataDict', 'edt_enum_sbw', 'body', 'edt_enum_sub_window', 'subWindow', '编辑字典定义', '', NULL),
(2025070100006356, 'EM006356', 56, 'DataDict', 'edt_enum_sbw', 'edt_enum_sub_window', 'edt_enum_sbw_div', 'div', '', 'class="showWithRowDivGrid"', NULL),
(2025070100006357, 'EM006357', 57, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'sysDictId', 'input', '字典记录id', 'out="Y"', '{"hide":true}'),
(2025070100006358, 'EM006358', 58, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'enumCode', 'input', '枚举码', 'out="Y"', '{"valueFrmWeb":"enumCode"}'),
(2025070100006359, 'EM006359', 59, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'enumValue', 'input', '枚举值', 'out="Y"', '{"valueFrmWeb":"enumValue"}'),
(2025070100006360, 'EM006360', 60, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_div', 'description', 'input', '描述', 'out="Y"', '{"valueFrmWeb":"description"}'),
(2025070100006361, 'EM006361', 61, 'DataDict', 'edt_enum_sbw', 'edt_enum_sub_window', 'edt_enum_sbw_footer_div', 'div', '', 'class="subWidowFooter"', NULL),
(2025070100006362, 'EM006362', 62, 'DataDict', 'edt_enum_sbw', 'edt_enum_sbw_footer_div', 'edtEnumButton', 'button', '提交', 'class="inputArea_sub_button"', NULL);
...
(2025070100006303, 'DataDict', 'add_dict_sbw', 'addDictButton', 'success', 'closeSw', '', '', '{"subWindowId":"add_dict_sub_window"}'),
...
(2025070100006315, 'DataDict', 'add_enum_sbw', 'addEnumButton', 'success', 'closeSw', '', '', '{"subWindowId":"add_enum_sub_window"}'),
...
(2025070100006307, 'DataDict', 'edt_dict_sbw', 'edtDictButton', 'success', 'closeSw', '', '', '{"subWindowId":"edt_dict_sub_window"}'),
...
(2025070100006319, 'DataDict', 'edt_enum_sbw', 'edtEnumButton', 'success', 'closeSw', '', '', '{"subWindowId":"edt_enum_sub_window"}'),
