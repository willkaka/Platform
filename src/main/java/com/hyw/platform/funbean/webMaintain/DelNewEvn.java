...
@Service("delNewEvn")
@Slf4j
public class DelNewEvn extends RequestFunUnit<String, DelNewEvn.QueryVariable> {
     ...
     */
    @Override
    public void checkVariable(DelNewEvn.QueryVariable variable){
        //输入检查
    ...
    @Override
    public String execLogic(PublicReq publicReq, DelNewEvn.QueryVariable dto){
