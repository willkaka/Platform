...
@Service("dtaDel")
@Slf4j
public class DtaDel extends RequestFunUnit<String, DtaDel.QueryVariable> {
     ...
     */
    @Override
    public void checkVariable(DtaDel.QueryVariable variable){
        //输入检查
    ...
    @Override
    public String execLogic(PublicReq publicReq, DtaDel.QueryVariable dto){
